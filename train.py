...
if __name__=='__main__':
	...
	car_train_folder= ['./train_data/vehicles/GTI_Far', './train_data/vehicles/GTI_Left', './train_data/vehicles/GTI_MiddleClose', './train_data/vehicles/GTI_Right', './train_data/vehicles/KITTI_extracted']	
	notcar_train_folder = ['./train_data/non-vehicles/Extras', './train_data/non-vehicles/GTI']
